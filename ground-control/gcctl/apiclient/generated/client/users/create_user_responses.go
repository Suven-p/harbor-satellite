...
func (o *CreateUserCreated) Error() string {
	...
	return fmt.Sprintf("[POST /api/users][%d] createUserCreated %s", 201, payload)
}
...
func (o *CreateUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/users][%d] createUserUnauthorized %s", 401, payload)
}
...
func (o *CreateUserConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/users][%d] createUserConflict %s", 409, payload)
}
