...
type LogoutHandlerFunc func(LogoutParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn LogoutHandlerFunc) Handle(params LogoutParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// LogoutHandler interface for that can handle valid logout params
type LogoutHandler interface {
	Handle(LogoutParams, any) middleware.Responder
}
...
/*
	Logout swagger:route POST /api/logout auth logout

# Delete the current session

Requires a bearer token for session invalidation.
*/
type Logout struct {
